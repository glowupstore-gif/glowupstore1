    ...
    <article className="group relative flex flex-col overflow-hidden rounded-2xl border border-border bg-card transition-all duration-300 hover:shadow-card-hover hover:-translate-y-1">
      ...
      <div className="flex flex-1 flex-col p-3">
        ...
        <div className="mt-auto pt-3">
          ...
          <p className="mt-1.5 flex items-center justify-center gap-1.5 text-center text-[11px] font-medium text-green-600">
            <svg viewBox="0 0 24 24" className="h-3.5 w-3.5 shrink-0 fill-green-600" aria-hidden="true">
